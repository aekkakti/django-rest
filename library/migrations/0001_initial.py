...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=100, unique=True, verbose_name='Название книги')),
                ...
                ('type', models.CharField(choices=[('textbook', 'Учебник'), ('fiction', 'Художественная литература')], default='Учебник', max_length=10)),
